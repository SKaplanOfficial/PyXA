...
.. autosummary:: PyXA.apps.TextEdit
   :nosignatures:

   ~PyXA.apps.TextEdit.XATextEditApplication
   ~PyXA.apps.TextEdit.XATextEditDocumentList
   ~PyXA.apps.TextEdit.XATextEditDocument
   ~PyXA.apps.TextEdit.XATextEditWindow

XATextEditApplication Methods
*****************************
   
.. autosummary:: PyXA.apps.TextEdit.XATextEditApplication
   :nosignatures:

   ~PyXA.apps.TextEdit.XATextEditApplication.print
   ~PyXA.apps.TextEdit.XATextEditApplication.documents
   ~PyXA.apps.TextEdit.XATextEditApplication.new_document
   ~PyXA.apps.TextEdit.XATextEditApplication.make
   
XATextEditDocumentList Methods
******************************
   
.. autosummary:: PyXA.apps.TextEdit.XATextEditDocumentList
   :nosignatures:
   
   ~PyXA.apps.TextEdit.XATextEditDocumentList.properties
   ~PyXA.apps.TextEdit.XATextEditDocumentList.path
   ~PyXA.apps.TextEdit.XATextEditDocumentList.name
   ~PyXA.apps.TextEdit.XATextEditDocumentList.text
   ~PyXA.apps.TextEdit.XATextEditDocumentList.paragraphs
   ~PyXA.apps.TextEdit.XATextEditDocumentList.words
   ~PyXA.apps.TextEdit.XATextEditDocumentList.characters
   ~PyXA.apps.TextEdit.XATextEditDocumentList.attribute_runs
   ~PyXA.apps.TextEdit.XATextEditDocumentList.attachments
   ~PyXA.apps.TextEdit.XATextEditDocumentList.modified
   ~PyXA.apps.TextEdit.XATextEditDocumentList.by_properties
   ~PyXA.apps.TextEdit.XATextEditDocumentList.by_path
   ~PyXA.apps.TextEdit.XATextEditDocumentList.by_name
   ~PyXA.apps.TextEdit.XATextEditDocumentList.by_modified
   ~PyXA.apps.TextEdit.XATextEditDocumentList.prepend
   ~PyXA.apps.TextEdit.XATextEditDocumentList.append
   ~PyXA.apps.TextEdit.XATextEditDocumentList.reverse

XATextEditDocument Methods
**************************
   
.. autosummary:: PyXA.apps.TextEdit.XATextEditDocument
   :nosignatures:
   
   ~PyXA.apps.TextEdit.XATextEditDocument.close
   ~PyXA.apps.TextEdit.XATextEditDocument.save
   ~PyXA.apps.TextEdit.XATextEditDocument.copy

For all classes, methods, and inherited members on one page, see the :ref:`TextEdit Module Reference`