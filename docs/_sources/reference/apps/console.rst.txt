...
.. toctree::
   ...
   ../api/apps/console/XAConsoleApplication/PyXA.apps.Console.XAConsoleApplication

.. toctree::
   :maxdepth: 1
   :caption: Methods

   ../api/apps/console/XAConsoleApplication/PyXA.apps.Console.XAConsoleApplication.select_device

For all classes, methods, and inherited members on one page, see the :ref:`Complete Console API`