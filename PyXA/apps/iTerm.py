...
class XAiTermApplication(XABaseScriptable.XASBApplication):
    ...
    def create_window(
        self, profile: Union[str, None] = None, command: Union[str, None] = None
    ) -> "XAiTermWindow":
    ...
    def launch_api_script(
        self, script_name: str, arguments: Union[list[str], None] = None
    ):
...
class XAiTermWindow(
    XABaseScriptable.XASBWindow, XABase.XAObject, XASelectable, XACloseable
):
...
class XAiTermSession(XABase.XAObject, XACloseable, XASelectable):
    ...
    def write(
        ...
        file: Union[XABase.XAPath, str, None] = None,
        ...
        if file is None:
            ...
            self.xa_elem.writeContentsOfFile_text_newline_(
                file.xa_elem, text, add_newline
            )
