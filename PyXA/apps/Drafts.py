...
class XADraftsApplication(XABaseScriptable.XASBApplication, XACanOpenPath):
    ...
    class ObjectType(Enum):
        """Object types that can be created using :func:`XADraftsApplication.make`."""
    ...
    def make(
        self,
        specifier: Union[str, "XADraftsApplication.ObjectType"],
        ...
        :type specifier: Union[str, XADraftsApplication.ObjectType]
        ...
        .. versionadded:: 0.0.8
        """
        if isinstance(specifier, XADraftsApplication.ObjectType):
