...
class XAAcrobatReaderApplication(
    ...
    def default_zoom_type(
        self, default_zoom_type: "XAAcrobatReaderApplication.ZoomType"
    ):
    ...
    def fullscreen_cursor(
        self, fullscreen_cursor: "XAAcrobatReaderApplication.CursorSetting"
    ):
    ...
    def page_units(
        self,
    ) -> Literal["Points", "Picas", "Inches", "Millimeters", "Centimeters"]:
    ...
    def page_units(
        self,
        page_units: Literal["Points", "Picas", "Inches", "Millimeters", "Centimeters"],
    ):
    ...
    def page_layout(
        self,
    ) -> Literal["Single Page", "Continuous", "Continuous - Facing", "Facing"]:
    ...
    def documents(
        ...
        return self._new_element(
            self.xa_scel.documents(), XAAcrobatReaderDocumentList, filter
        )
...
class XAAcrobatReaderDocumentList(XABase.XAList):
    ...
    ) -> Union["XAAcrobatReaderDocument", None]:
        x = bounds[0]
        y = bounds[1]
        w = bounds[2]
        h = bounds[3]
    ...
    def by_file_alias(
        self, file_alias: Union[str, XABase.XAPath]
    ) -> Union["XAAcrobatReaderDocument", None]:
    ...
    def by_view_mode(
        self, view_mode: XAAcrobatReaderApplication.ViewMode
    ) -> Union["XAAcrobatReaderDocument", None]:
...
class XAAcrobatReaderDocument(XABase.XAObject):
    ...
    def bookmarks(
        ...
        """
        return self._new_element(
            self.xa_elem.bookmarks(), XAAcrobatReaderBookmarkList, filter
        )
...
class XAAcrobatReaderPDFPageList(XABase.XAList):
    ...
    def by_bleed_box(
        self, bleed_box: list[float]
    ) -> Union["XAAcrobatReaderPDFPage", None]:
        return self.by_property("bleedBox", bleed_box)

    def by_crop_box(
        self, crop_box: list[float]
    ) -> Union["XAAcrobatReaderPDFPage", None]:
...
class XAAcrobatReaderBookmarkList(XABase.XAList):
    ...
    def destination_page_number(self) -> list[int]:
        return list(
            self.xa_elem.arrayByApplyingSelector_("destinationPageNumber") or []
        )
    ...
    def by_default_type(
        self, default_type: str
    ) -> Union["XAAcrobatReaderBookmark", None]:
        return self.by_property("defaultType", default_type)

    def by_destination_page_number(
        self, destination_page_number: int
    ) -> Union["XAAcrobatReaderBookmark", None]:
        return self.by_property("destinationPageNumber", destination_page_number)

    def by_destination_rectangle(
        self, destination_rectangle: list[float]
    ) -> Union["XAAcrobatReaderBookmark", None]:
        return self.by_property("destinationRectangle", destination_rectangle)

    def by_fit_type(
        self, fit_type: XAAcrobatReaderApplication.FitType
    ) -> Union["XAAcrobatReaderBookmark", None]:
...
class XAAcrobatReaderAnnotationList(XABase.XAList):
    ...
    ) -> Union["XAAcrobatReaderAnnotation", None]:
        return self.by_property("bounds", bounds)

    def by_color(
        self, color: XABase.XAColor
    ) -> Union["XAAcrobatReaderAnnotation", None]:
...
class XAAcrobatReaderMenuItemList(XABase.XAList):
    ...
    def by_default_type(
        self, default_type: str
    ) -> Union["XAAcrobatReaderMenuItem", None]:
        return self.by_property("defaultType", default_type)
