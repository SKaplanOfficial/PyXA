...
class XAMusicApplication(XABaseScriptable.XASBApplication):
    ...
    def play(self, item: 'XAMusicItem' = None, play_once: bool = True) -> 'XAMusicApplication':
...
class XAMusicPlaylist(XAMusicItem):
    ...
    def __init__(self, properties):
        ...
        if not hasattr(self, "xa_specialized"):
            if object_class == MusicObjectClass.LIBRARY_PLAYLIST or self.special_kind == XAMusicApplication.PlaylistKind.LIBRARY or self.special_kind == XAMusicApplication.PlaylistKind.USER_LIBRARY:
...
class XAMusicLibraryPlaylist(XAMusicPlaylist):
    ...
    def file_tracks(self, filter: Union[dict, None] = None) -> 'XAMusicFileTrackList':
        ...
        .. versionadded:: 0.0.7
        """
        return self._new_element(self.xa_elem.fileTracks(), XAMusicFileTrackList, filter)
    ...
    def shared_tracks(self, filter: Union[dict, None] = None) -> 'XAMusicSharedTrackList':
        ...
        .. versionadded:: 0.0.7
        """
        return self._new_element(self.xa_elem.sharedTracks(), XAMusicSharedTrackList, filter)
...
class XAMusicSource(XAMusicItem):
    ...
    def library_playlists(self, filter: Union[dict, None] = None) -> 'XAMusicLibraryPlaylistList':
        ...
        .. versionadded:: 0.0.7
        """
        return self._new_element(self.xa_elem.libraryPlaylists(), XAMusicLibraryPlaylistList, filter)
    ...
    def user_playlists(self, filter: Union[dict, None] = None) -> 'XAMusicUserPlaylistList':
        ...
        .. versionadded:: 0.0.7
        """
        return self._new_element(self.xa_elem.userPlaylists(), XAMusicUserPlaylistList, filter)
